package com.lastikler_tatilde.tatildekiler.config;
...
public class AppConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Lastikler Tatilde - REST APIs")
                .description("Spring Boot starter kit application.").termsOfServiceUrl("")
                .contact(new Contact("İsmail Murat", "", "karakose.ismailmurat@gmail.com"))
