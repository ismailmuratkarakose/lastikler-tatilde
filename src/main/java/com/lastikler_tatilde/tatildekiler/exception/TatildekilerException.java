package com.lastikler_tatilde.tatildekiler.exception;

import com.lastikler_tatilde.tatildekiler.config.PropertiesConfig;
...
@Component
public class TatildekilerException {

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public TatildekilerException(PropertiesConfig propertiesConfig) {
        TatildekilerException.propertiesConfig = propertiesConfig;
    }
