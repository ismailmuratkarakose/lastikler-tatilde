package com.lastikler_tatilde.tatildekiler;
...
public class LastiklerTatildeApplication {

    public static void main(String[] args) {
        SpringApplication.run(LastiklerTatildeApplication.class, args);
    }
        ...
        return args -> {
            ...
            if (passenger == null) {
                passenger = new User()
                        ...
                        .setPassword("$2a$10$7PtcjEnWb/ZkgyXyxY1/Iei2dGgGQUbqIIll/dt.qJ8l8nQBWMbYO") // "123456"
                        .setFirstName("Ismail Murat")
                        .setLastName("Karaköse")
                        .setMobileNumber("9425094250")
