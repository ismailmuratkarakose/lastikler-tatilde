...
import com.lastikler_tatilde.tatildekiler.dto.mapper.TicketMapper;
import com.lastikler_tatilde.tatildekiler.dto.mapper.TripMapper;
import com.lastikler_tatilde.tatildekiler.dto.mapper.TripScheduleMapper;
import com.lastikler_tatilde.tatildekiler.dto.model.bus.*;
import com.lastikler_tatilde.tatildekiler.dto.model.user.UserDto;
import com.lastikler_tatilde.tatildekiler.model.bus.*;
import com.lastikler_tatilde.tatildekiler.model.user.User;
import com.lastikler_tatilde.tatildekiler.repository.bus.*;
import com.lastikler_tatilde.tatildekiler.repository.user.UserRepository;
import com.lastikler_tatilde.tatildekiler.util.RandomStringUtil;
import com.lastikler_tatilde.tatildekiler.dto.model.bus.*;
...
import static com.lastikler_tatilde.tatildekiler.exception.EntityType.*;
import static com.lastikler_tatilde.tatildekiler.exception.ExceptionType.*;
...
public class BusReservationServiceImpl implements BusReservationService {
    ...
    private RuntimeException exceptionWithId(EntityType entityType, ExceptionType exceptionType, String id, String... args) {
        return TatildekilerException.throwExceptionWithId(entityType, exceptionType, id, args);
    }
}
